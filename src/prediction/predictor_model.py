...
class Classifier:
    """A wrapper class for the Ridge binary classifier.

    This class provides a consistent interface that can be used with other
    classifier models.
    """

    model_name = "ridge_binary_classifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Construct a new Ridge binary classifier.

        Args:
            alpha (int, optional): Args: Constant that multiplies the L2 term, controlling regularization strength. alpha must be a non-negative
    ...
    def fit(self, train_inputs: pd.DataFrame, train_targets: pd.Series) -> None:
        """Fit the Ridge binary classifier to the training data.
